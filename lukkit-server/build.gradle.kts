...
dependencies {
    implementation(project(":lukkit-api"))
...
tasks.jar {
    manifest {
        ...
        attributes(
            "Main-Class" to "org.lukkitmc.lukkit.Main",
            "Implementation-Title" to "Lukkit",
            "Implementation-Version" to implementationVersion,
            "Implementation-Vendor" to date,
            "Specification-Title" to "Lukkit",
            "Specification-Version" to project.version,
            "Specification-Vendor" to "Lukkit Team",
            "Brand-Id" to "lukkitmc:lukkit",
            "Brand-Name" to "Lukkit",
        ...
        for (tld in setOf("net", "com", "org")) {
            attributes("$tld/lukkit", "Sealed" to true)
        }
    }
}
...
fun TaskContainer.registerRunTask(
    ...
    group = "runs"
    mainClass.set("org.lukkitmc.lukkit.Main")
